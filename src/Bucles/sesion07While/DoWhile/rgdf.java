...
public class rgdf {
    ...
    public static void main(String[] args) {
        ...
        switch (empezarONo) {  // y un solo caso donde agrupo todas las respuestas que consifero positivas,
            case "Si","SI","si","sI","1": // todo lo demas iran a al ultima default.
                            ...
                            case 2:
                                ...
                                switch (lenguajeJava) {
                                    case "a", "java", "Java":
                                        ...
                                        break;
                                    case "b", "c", "d", "kotlin", "Kotlin", "Scala", "scala", "Python", "python":
                 ...
                 cada vuelta del bucle, y le digo que se ejecute mientras j valga menos que 5, un valor menos que la
                  ...
                  igualmente. */
                    ...
                    if (j < 5) {
                        ...
                        String x = sc.next();
                        switch (x) {
                            case "sI", "Si", "SI", "si":             // Una vez creada una condición if que solo se repetirá hasta la
                            ...
                            case "no", "nO", "No", "NO":            // aumentado i y j y valiendo 1 mas cada bucle.
